...
from writracker.recorder.dataio import _parse_config_int_value, _parse_config_float_value, _parse_config_bool_value
=======
import data
...
>>>>>>> 2a984317832506ad948646c6d2408e63875ee17b
    ...
    for t in index:
<<<<<<< HEAD
        trial = wt.data.EncoderTrial(trial_id=t['trial_id'], target_id=t['target_id'], stimulus=t['target'],
...
def save_experiment(exp, dir_name):
    ...
    wt.recorder.dataio.reset_trial_info_file(dir_name)
